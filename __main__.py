...
# Dynamically add "opensky-api/python" to the Python import path
opensky_path = os.path.join(dname, "opensky-api", "python")  # Adjusted to point to 'python' subfolder
sys.path.insert(0, opensky_path)  # Add opensky-api/python to Python's import path

# Debugging print to confirm path
print(f"DEBUG: Added {opensky_path} to Python path inside __main__.py")

# Add current directory to Python's search path
sys.path.extend([os.getcwd()])

# Now, import the missing modules
from planeClass import Plane
from datetime import datetime
import pytz
import signal
from opensky_api import OpenSkyApi  # This should now work!
